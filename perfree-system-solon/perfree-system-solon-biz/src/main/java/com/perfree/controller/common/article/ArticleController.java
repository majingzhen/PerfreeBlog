...
public class ArticleController {
    ...
    @ApiOperation(value = "获取评论最多的热门文章文章")
    ...
    @ApiOperation(value = "获取浏览量最多的热门文章文章")
    ...
    @ApiOperation(value = "获取点赞最多的热门文章文章")
    ...
    @ApiOperation(value = "根据id获取下一篇文章")
    ...
    @ApiOperation(value = "根据id获取上一篇文章")
